(function initMaweI18n(global) {
  ...
  const EN_TEXT = {
    ...
    '媒体': 'Media', '预览字幕': 'Subtitle preview', '预览表情包': 'Sticker preview',
    ...
    '跳过空隙': 'Skip gaps', '播放时跳过空隙': 'Skip gaps during playback', '未扫描空隙': 'Gaps not scanned', '布局': 'Layout',
    ...
    '操作': 'Behavior', '通用操作': 'General', '单击行为': 'Click behavior', '点击字幕块时': 'Click subtitle behavior', '仅选中': 'Select only',
