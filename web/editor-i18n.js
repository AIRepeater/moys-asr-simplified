(function initMaweI18n(global) {
  ...
  const EN_TEXT = {
    ...
    '设置中开启「同时选中主副字幕」后，点击已绑定字幕会同时选中两条；编辑区仍以最后点击的字幕为准': 'When “Select main and secondary subtitles together” is enabled, clicking a bound subtitle selects both; the editor still follows the last clicked subtitle',
