(function initMaweI18n(global) {
  ...
  const EN_TEXT = {
    ...
    '移动鼠标点击，或用键盘选择拆分断点：Tab 切换主/副字幕，WASD/方向键移动 ✂️，空格确认或取消。': 'Click with the mouse, or use the keyboard to pick split points: Tab switches main/secondary, WASD/arrows move ✂️, Space confirms or cancels.',
